  ...
  if (rank.includes(m[1])) {
    ...
    if (file.includes(m[2]) && rank.includes(m[3])) {
      if (m[4] == "=" && pieces.includes(m[5])) {
        if (m[6] == "+" && fxM.fixMove(initial_Sq, m, color)) {
          console.log(
        ...
        } else if (m[6] == "#" && fxM.fixMove(initial_Sq, m, color)) {
          console.log(
        ...
        } else if (m[6] == undefined && fxM.fixMove(initial_Sq, m, color)) {
          console.log(
...
function kingMove(initial_Sq, m, color) {
  ...
  if (m[1] == "x" && m[4] == undefined) {
    ...
    if (
      rank.includes(rk) &&
      file.includes(fl) &&
      fxM.fixMove(initial_Sq, m, color)
    ) {
...
function pieceMove(initial_Sq, m, pc, color) {
  ...
  if (m[1] == "x") {
    ...
    (fl = m[1]), (rk = m[2]);
    if (m[3] == "+" && fxM.fixMove(initial_Sq, m, color)) {
      console.log(`${arrOfPieces[pc]} moved to ${fl}${rk} with check`);
      console.log(`----------xxxxxxxx-----Move Made----xxxxxxx----------\n`);
    } else if (m[3] == "#" && fxM.fixMove(initial_Sq, m, color)) {
      console.log(`${arrOfPieces[pc]} moved to ${fl}${rk} and checkmate`);
      console.log(`----------xxxxxxxx-----Move Made----xxxxxxx----------\n`);
    } else if (m[3] == undefined && fxM.fixMove(initial_Sq, m, color)) {
...
isCorrectMove("d7", "d5", 0);
isCorrectMove("e4", "exd5", 1);
isCorrectMove("d8", "qxd5", 0);
